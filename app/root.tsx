...
export default function App(){const {session,lang}=useLoaderData<typeof loader>();return <AppProvider initial={session} language={lang}><Shell><Outlet/></Shell></AppProvider>;}
